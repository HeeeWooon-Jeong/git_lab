			...
			<table class="tbl_row_type01">
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="3">
							<div class="text_area">
								<c:out value="${util:unEscape(btwoVO.btCont)}" escapeXml="false"/>
							</div>
						</td>
					</tr>
					<tr>
						...
						<td colspan="3">
							<iframe name="atchFileIdFrame" id="atchFileIdFrame" src="/atch/fileUpload.do?atchFileId=${btwoVO.btAtchFileSeq}&fileCnt=5&atchFileIdNm=btAtchFileSeq&updateType=view" style="width: 100%;" height="70" frameborder="0" title="파일 업로드 폼"></iframe>
