			...
			<table class="tbl_row_type01"> 
				...
				<tbody>
					<tr>
						...
						<td colspan="3">
							<input type="text" name="caTitle" id="caTitle" class="text w100p" value="${careVO.caTitle}" />
						</td>
					</tr>
					<tr>
						<th scope="row">내용</th>
					...
					<tr>
						...
						<td colspan="3">
							<iframe name="caAtchFileIdFrame" id="caAtchFileIdFrame" src="/atch/fileUpload.do?atchFileId=${careVO.caAtchFileSeq }&fileCnt=5&atchFileIdNm=caAtchFileSeq&updateType=upload" style="width: 100%;" height="100" frameborder="0" title="파일 업로드 폼"></iframe>
						</td>
					</tr>    
				</tbody>
			</table>
