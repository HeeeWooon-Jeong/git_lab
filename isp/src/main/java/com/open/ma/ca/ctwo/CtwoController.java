...
public class CtwoController {
	...
	public String proc(@ModelAttribute("searchVO") CtwoVO searchVO, Model model, SessionStatus status,@PathVariable String procType, HttpServletRequest request) throws Exception {
